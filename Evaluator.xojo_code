...
Inherits XojoScript
	#tag Event
		Function CompilerError(location As XojoScriptLocation, error As XojoScript.Errors, errorInfo As Dictionary) As Boolean
		  MsgBox(ErrorCodeToString(error))
	...
	#tag Method, Flags = &h0
		Function EvalToBoolean(expression As String) As Boolean
		  ...
		  "If expr.IsBoolean Then " + EndOfLine + _
		  "mResultBoolean = expr" +EndOfLine +  _
		  "End If"
	...
	#tag Method, Flags = &h0
		Function EvalToString(expression As String) As String
		  ...
		  source = "Dim expr As Variant = " + expression + EndOfLine + _
		  "If expr.IsString Then " + EndOfLine + _
		  "mResultString = expr" +EndOfLine +  _
		  "End If"
